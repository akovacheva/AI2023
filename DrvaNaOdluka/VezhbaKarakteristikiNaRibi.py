...
if __name__ == '__main__':
    ...
    #Poradi toa shto se od neprekinat tip, ne ni treba Ordinal Encoder

    #Odma pocnuvame so podelba na mnozestavta
    ...
    classifier2 = RandomForestClassifier(n_estimators=num_trees, criterion=crit, random_state=0)
    ...
    predicted_class = classifier2.predict([new_list])[0]
    print(predicted_class)
    print(classifier.predict_proba([new_list])[0])
